...
public record TicketQuery(TicketStatus status, TicketType type, TicketPriority priority, String serviceCatalogItemId,
                          ...
                          String keyword, TicketQueue queue,String teamQueueCode, Instant todayDueFrom, Instant todayDueTo,
    ...
    public TicketQuery(TicketStatus status, TicketType type, String keyword) {
        this(status, type, null, null, null, null, null, keyword, TicketQueue.ALL,null, null, null, null,null, Instant.MAX, null, null, Integer.MAX_VALUE);
    }
}
