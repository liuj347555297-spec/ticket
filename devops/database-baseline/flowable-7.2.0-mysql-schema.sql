-- Flowable 7.2.0 MySQL schema baseline for ServiceHub V26.
-- Generated from a clean ServiceHub Flowable 7.2.0 schema on 2026-08-30.
-- DDL only: excludes process deployments, process instances, runtime/history data and identities.
-- Import into an empty ServiceHub database before the first production application startup.
...
-- Flowable uses this small metadata set to recognise a fully initialised 7.2.0.2
-- schema.  It is configuration/version metadata, not a process, identity or runtime record.
INSERT INTO `ACT_GE_PROPERTY` (`NAME_`, `VALUE_`, `REV_`) VALUES
  ...
  ('common.schema.version', '7.2.0.2', 1),
  ('eventregistry.schema.version', '7.2.0.2', 1),
  ('next.dbid', '1', 1),
  ('schema.history', 'create(7.2.0.2)', 1),
  ('schema.version', '7.2.0.2', 1);
